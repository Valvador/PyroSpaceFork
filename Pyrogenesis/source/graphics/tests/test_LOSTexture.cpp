...
CxxTest::StaticSuiteDescription suiteDescription_TestLOSTexture( "..\\..\\..\\source\\graphics\\tests\\test_LOSTexture.h", 25, "TestLOSTexture", suite_TestLOSTexture, Tests_TestLOSTexture );

static class TestDescription_TestLOSTexture_test_basic : public CxxTest::RealTestDescription {
public:
 TestDescription_TestLOSTexture_test_basic() : CxxTest::RealTestDescription( Tests_TestLOSTexture, suiteDescription_TestLOSTexture, 28, "test_basic" ) {}
...
public:
 TestDescription_TestLOSTexture_test_perf_DISABLED() : CxxTest::RealTestDescription( Tests_TestLOSTexture, suiteDescription_TestLOSTexture, 62, "test_perf_DISABLED" ) {}
